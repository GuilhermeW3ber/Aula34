...
function setup() {
  ...
  muteBtn.position(30,30);
  muteBtn.size(50,50);
  muteBtn.mouseClicked(cutSound);
  
  rope = new Rope(7,{x:245,y:30});
  rope2 = new Rope(8,{x:370,y:40});
  rope3= new Rope(4,{x:400,y:250});
  ...
  bunny = createSprite(470,canH-80,100,100);
  bunny.scale = 0.2;
...
{
  background(51);
  image(bg_img,0,0,displayWidth+80,windowHeight);
